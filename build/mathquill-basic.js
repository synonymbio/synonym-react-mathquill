...
(function () {
    ...
    var NodeBase = /** @class */ (function () {
        ...
        NodeBase.prototype.getDOM = function () {
            return this._el;
        };
    ...
    function getInterface(v) {
        ...
        var AbstractMathQuill = /** @class */ (function (_super) {
             ...
             * semantic type.
             */
            AbstractMathQuill.prototype.parseSemanticTypes = function () {
                var identifiers = [];
                var identifier = [];
                ...
                for (var _i = 0, bracketNodes_1 = bracketNodes; _i < bracketNodes_1.length; _i++) {
                    var bracketNode = bracketNodes_1[_i];
